...
\TermEntry{jukugo 熟語} \quote{mellowed word}: Compound word of two or more kanji. Kanji often take their on' readings when appearing this way, as in the case of the word \hbox{熟語} itself (on'yomi ジュク + ゴ).
...
\TermEntry{maru 丸} \quote{circle}: The \Grapheme{ﾟ} diacritic applied to kana of the \Phoneme{h}-column to change their onset sound to \Phoneme{p}. More formally called handakuten \hbox{半濁点} \quote{half dakuten}.
...
\TermEntry{nanori 名乗り} \quote{name declaration}: Pronunciation of kanji in names that may have a unique reading, neither on'yomi nor kun'yomi. Example: The place name \hbox{長谷} is read as \ja\quotation{はせ}\en, neither of which are standard readings for those kanji.
