...
\placefigure[here]
  {Where does は fit into our train model?}
...
Let's take an example. There's an old joke among Japanese learners, and it's only possible because of how badly Japanese is taught. The joke is: A group of people are dining in a restaurant and they're discussing what they're going to eat, and somebody says\JPN{\quotation{私はうなぎだ。}うなぎ} means \quote{eel}, so the joke is that this person has literally said \quotation{I am an eel.} After all, if \JPN{私はアメリカ人だ} means \quote{I am an American}, then \JPN{私はうなぎだ} must mean \quote{I am an eel.} That's absolutely perfect logic---except that \JPN{私はアメリカ人だ} doesn't mean \quote{I am an American.} It means \quote{As for me, I am an American.}
